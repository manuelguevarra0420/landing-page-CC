...
export default function news() {
	return(
		<React.Fragment>
			<Head>
				<title>Top 50 Free Things To Do in Rome</title>
			</Head>
			<Container md="fluid">
				<Navigation />
				...
				<div className="newsblog">
					<p className="minititle">REPUBLIC EXPERIENCE</p>
					<h1 className="newstitle">Top 50 Free Things To Do in Rome</h1>
					<p className="newsdate">April 4, 2021, 3:16 pm</p>
					<p className="content">"But I must explain to you how all this mistaken idea 
					...
					will give you a complete account of the system, and expound
					 ...
					 no annoying consequences, or one who avoids a pain that produces 
